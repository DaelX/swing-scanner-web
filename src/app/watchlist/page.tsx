    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
        <div>
          ...
          <p className="text-sm text-slate-400">
            {scanDate
              ? `${scanDate} · ${stocks.length} stocks tracked`
      ...
      {loading && (
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8 mb-4 text-center">
          ...
          <p className="text-slate-400 text-sm">Loading watchlist data...</p>
        </div>
      )}
      ...
      {!loading && stocks.length === 0 && !error && (
        <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-8 text-center text-slate-400">
          No watchlist data yet. The cache writer needs to run to populate your watchlist.
        </div>
      )}
